...
class ContactHelper:
    ...
    def fill_contact_form(self, contact):
        ...
        self.change_field_value("telephone_home", contact.telephone_home)
        self.change_field_value("telephone_mobile", contact.telephone_mobile)
        self.change_field_value("telephone_work", contact.telephone_work)
