...
class TestAddContact(unittest.TestCase):
    ...
    def create_contact(self, wd, contact):
        ...
        wd.find_element("xpath","//option[@value='9']").click()
    ...
    def test_add_contact(self):
        ...
        self.create_contact(wd, Group(firstname="2",middlename="1", lastname="3", nickname="4", title="5", address="7", company="6", home="8", mobile="9",
                            work="10", fax="11", email="12", email2="13", email3="14", homepage="15", bday="9",
